...
namespace jxlNET.Encoder.Parameters
{
    ...
    /// <summary>
    /// "already_downsampled, Do not downsample before encoding, but still signal that the decoder should upsample.",
    /// </summary>
    ...
    public class AlreadyDownsampled : jxlNET.Parameter
    {
        ...
        public override string ParamLong => "--already_downsampled";
