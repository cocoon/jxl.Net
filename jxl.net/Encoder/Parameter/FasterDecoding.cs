...
{
    /// <summary>
    /// "Higher values improve decode speed at the expense of quality or density, default = 0. (0..4)"
    /// </summary>
    ...
    public class FasterDecoding : jxlNET.Parameter
    {
        ...
        public override string ParamLong => "--faster_decoding";
        public override OptionType OptionType => OptionType.Value;

        //Constructor
        public FasterDecoding() { }
        public FasterDecoding(int Value)
        {
            this.Value = Value;
        }
